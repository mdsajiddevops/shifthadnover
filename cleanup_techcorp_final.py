#!/usr/bin/env python3
"""
Final comprehensive cleanup script to remove all handover reports and notification data 
for Account "TechCorp Solutions" (ID: 1) and Team "Operations Team" (ID: 2)
Handles ALL foreign key constraints by deleting in the correct order.
"""
...
def cleanup_techcorp_data_final():
    ...
    with app.app_context():
        try:
            ...
            # STEP 9: Clean up any remaining notification-related data
            ...
            # STEP 10: Delete any incident notifications for this team
            ...
            if (remaining_notifications == 0 and remaining_request_notifications == 0 and 
                remaining_requests == 0 and remaining_shifts == 0):
