...
def dashboard():
    ...
    # Add pending assignments count for notification panel
    from models.models import IncidentAssignment
    try:
        ...
        print(f'[DEBUG] Dashboard: Found {pending_count} pending assignments for user {current_user.id}')
    except Exception as e:
        print(f'[ERROR] Dashboard: Error getting pending assignments: {e}')
        pending_assignments = []
        pending_count = 0
